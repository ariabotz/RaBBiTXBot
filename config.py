...
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://ariaputrapratamaaaa:jys25mZSkyH3x9jo@cluster0.nebsqze.mongodb.net/?retryWrites=true&w=majority") # MONGO_URI fill here mongodb database url get it by mongodb.com
